...
import globalCompanyNames from "../../common/globalCompanyNames.json";
import {get} from "lodash";
import "./decimalFraction.css"; 
import {
   NumberInput,
   Form,
   Grid,
 ...
 export const DecimalFractionTable = (props) => {
    let { id } = useParams();
                    ...
                    <Grid>
                        <Row>
                            <Column lg={12} className="large-padding-top large-padding-bottom">
                                <h1 className="text-reverse header-text-large">{calculatorTilesAndDESC('HEAD','decimalFraction',domain,lang)}</h1>
                                <p className="text-reverse">{globalCompanyNames.companyNameGlobal}'s {calculatorTilesAndDESC('DESC','decimalFraction',domain,lang)}</p>
                            </Column>
                        </Row>
                    </Grid>
                </div>  
            ...
            <div className="bg-grey-light bg-full-width padding-top calculator-text-override">
                <div className="bg-full-width-inner padding-bottom">
                    <Grid>
                        <Row>
                            <Column lg={12}>
                                <h3>{calculatorTilesAndDESC('SUBHEAD','decimalFraction',domain,lang)}</h3>
                            </Column>
                        </Row>
                        <Row>
                            <Column lg={12}>
                                <Form>
                                    <Row>
                                        ...
                                        <Column sm={3} md={1} lg={1}  className="equalSymbol">=</Column>
                                
                                        <Column sm={2} md={2} lg={2} className="form-group WNumber">
                                        ...
                                        <Column sm={2} md={3} lg={6} className="form-group FDeciaml">
                                            <Row>
                                                <Column sm={3} md={3} className="form-group numeratorDiv">
                                                ...
                                                <Column  className="dividerSymbol">/</Column>
                                                <Column sm={3} md={3} className="form-group denominatorDiv" >
            ...
            <div className="bg-white bg-full-width padding-top calculator-text-override">
                <div className="bg-full-width-inner larger-padding-bottom">
                    <Grid>
                        <Row>
                            <Column lg={12}>
                                <h3>{calculatorTilesAndDESC('CHEAD','decimalFraction',domain,lang)}</h3>
                                <div className="form-force-width">

                                {/*<DataTable rows={dFConvertionData} headers={headers}>
            ...
            <div className="bg-grey-light bg-full-width padding-top calculator-text-override">
                <div className="bg-full-width-inner padding-bottom">
                    <Grid>
                        <Row>
                            <Column lg={12}>
                                <a className="btn btn-secondary" href="">{calculatorTilesAndDESC('CTMB','decimalFraction',domain,lang)}</a>
                            </Column>
                        </Row>
                    </Grid>
                </div>
